...
function(soa_apply_build_options target)
    if(SOA_PORTABLE_CXX_OPTIONS)
        target_compile_options(${target} PRIVATE
                "$<$<COMPILE_LANGUAGE:CXX>:${SOA_PORTABLE_CXX_OPTIONS}>"
        )
    endif()

    target_compile_definitions(${target} PRIVATE
            "$<$<COMPILE_LANGUAGE:CXX>:SPDLOG_ACTIVE_LEVEL=SPDLOG_LEVEL_TRACE>"
            "$<$<COMPILE_LANGUAGE:CXX>:SOA_LAUNCHER_VERSION=\"${PROJECT_VERSION}\">"
            "$<$<COMPILE_LANGUAGE:CXX>:SOA_LAUNCHER_UPDATE_MANIFEST_URL=\"${SOA_LAUNCHER_UPDATE_MANIFEST_URL}\">"
            "$<$<COMPILE_LANGUAGE:CXX>:SOA_LAUNCHER_UPDATE_FALLBACK_MANIFEST_URL=\"${SOA_LAUNCHER_UPDATE_FALLBACK_MANIFEST_URL}\">"
            "$<$<COMPILE_LANGUAGE:CXX>:SOA_LAUNCHER_UPDATE_PUBLIC_KEY_HEX=\"${SOA_LAUNCHER_UPDATE_PUBLIC_KEY_HEX}\">"
            "$<$<COMPILE_LANGUAGE:CXX>:SOA_RULES_DOCUMENT_URL=\"${SOA_RULES_DOCUMENT_URL}\">"
    )
endfunction()
