...
namespace wset = soa::ui::layout::wine_settings;
...
WineSettings::WineSettings(soa::runtime::Shell* shell_, QWidget* parent)
...
void WineSettings::setup_dxvk_option()
{
    ...
    slider->setIcon(QIcon(
        soa::ui::assets::button(soa::ui::assets::Button::SliderOff).normal.scaled(
    ...
    {
        const auto& a = on ? soa::ui::assets::button(soa::ui::assets::Button::SliderOn)
...
void WineSettings::setup_prefix_option()
{
    ...
    soa::ui::simple_utils::make_label_block(this, w, y, title, description);
...
void WineSettings::setup_wine_binary_option()
{
    ...
    auto* field = new QLineEdit(this);
    field->setPlaceholderText(soa::i18n::translate("system wine"));
...
void WineSettings::setup_tricks_option()
{
    ...
    auto* field = new QLineEdit(this);
    field->setPlaceholderText(soa::i18n::translate("from %1").arg(QStringLiteral("PATH")));
    ...
    {
        const QString file = QFileDialog::getOpenFileName(
            this, soa::i18n::translate("Select Winetricks"));
        if (!file.isEmpty())
        {
...
void WineSettings::setup_wine_args_option()
{
    ...
    field->setGeometry(ls::ctrl_pos(w, y).x(), ls::ctrl_pos(w, y).y(),
                       ls::ctrl_w(w), qMax(32, soa::ui::layout::scaled(40, w)));
