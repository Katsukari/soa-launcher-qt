...
WineInstall::WineInstall(soa::runtime::Shell* shell_, QWidget* parent) : ModalOverlay(parent), shell(shell_)
{
...
void WineInstall::start_install()
{
    ...
    const soa::runtime::RuntimeType type = soa::runtime::WineRegistry::identify(wine_path);

    if (type == soa::runtime::RuntimeType::Proton && !soa::runtime::umu_available())
    {
...
void WineInstall::paint_content(QPainter& painter)
{
    ...
    painter.drawText(
        ...
        soa::i18n::translate(description));
    ...
    painter.drawText(path_rect.adjusted(soa::ui::layout::scaled(10, w), soa::ui::layout::scaled(8, w), -soa::ui::layout::scaled(10, w), 0), Qt::AlignTop | Qt::AlignLeft, soa::i18n::translate("DEFAULT INSTALLATION PATH"));
    ...
    painter.setPen(soa::ui::colors::k_text_maroon);
    const QRect path_text_rect = path_rect.adjusted(soa::ui::layout::scaled(14, w), soa::ui::layout::scaled(34, w), -soa::ui::layout::scaled(14, w), 0);
    ...
    if (!warn_message.isEmpty())
    {
        ...
        painter.drawText(soa::ui::layout::install_modal::warning_line(w),
                         Qt::AlignHCenter | Qt::AlignVCenter, soa::i18n::translate(warn_message));
    }
}
